    ...
    <form action="">
      <table class="col-12">
          ...
          <td>
            <p>
              ...
              <span class="dropdownContainer">
                ...
                <input type="radio" id="working" name="status" checked> Working  </label>
        ...
        <tr>
          <td class="col-11">
            <p>
              <label for="edit-plate"><b>Date acquired:</b></label>
              <input type="date" id="date-acquired"  class="editBox"  name="" value="" placeholder="Date acquired" />
            </p>
          </td>
        </tr>
