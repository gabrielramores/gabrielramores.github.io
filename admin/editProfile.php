...
<div class="py-5 px-2" style="background: gainsboro;">
  ...
  <div class="container-fluid col-lg-6 border p-3 shadow" style="background: white; border-radius: 5px;">
    <div class="container-fluid my-2 p-0 d-flex flex-row-reverse">
      <button type="button" class="close m-0 px-2" aria-label="Close" onclick="window.location.href='adminProfile.php'">
  ...
  <hr class="my-4">
    ...
    <form action="">
      ...
      <center>
        ...
        <button type="reset" class="btn btn-warning my-5 shadow-none col-3" onclick="window.location.href='adminProfile.php'">
          Cancel
        </button>
      </center>
    </form>
